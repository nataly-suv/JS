...
// ищем есть ли фото в продукте
const productsSecondFoto = productsSecond.filter((element) => {
  if (Object.keys(element).includes('photos') && element.photos.length > 0) {
    return true;
  }
});

console.log(productsSecondFoto);

// сортировка по цене
productsSecond.sort((a, b) => (a.price > b.price ? 1 : -1));
console.log(productsSecond);
